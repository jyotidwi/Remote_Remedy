...
doctors = client.get_database("remoteremedy").doctors
patients = client.get_database("remoteremedy").patients
website_feedback = client.get_database("remoteremedy").website_feedback
...
def forgot_password():
    ...
    msg = Message("Password Reset Request",
                    ...
                    recipients=[email])
    msg.body = f"To reset your password, visit the following link: https://jyotidwi-remoteremedy.vercel.app/reset-password/{token}"
    mail.send(msg)
