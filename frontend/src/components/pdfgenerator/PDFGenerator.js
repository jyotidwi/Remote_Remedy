...
const PDFGenerator = ({name, age, gender, selectedDoc}, prescription) => {
    ...
    pdf.text("2024 @RemoteRemedy | All Rights Reserved", pdf.internal.pageSize.width - 40 - pdf.getStringUnitWidth("2025 @RemoteRemedy | All Rights Reserved") * pdf.internal.getFontSize(), pdf.internal.pageSize.height - 30);
