...
const AccountForm = ({ isSignup, setIsSignup }) => {
  ...
  const [isRemoteRemedyAuth, setIsRemoteRemedyAuth] = useState(true);
  const setCurrAuthApp = [setIsRemoteRemedyAuth, setIsGoogleAuth];
                    ...
                    <div class="flex items-center justify-center gap-x-6">
                      <div class="relative flex h-[40px] w-[40px] items-center justify-center">
                        <input
                          ...
                          id="RemoteRemedyAuth"
                          name="authMethod"
                          value="RemoteRemedyAuth"
                          class="peer z-10 h-full w-full opacity-0"
                          onChange={() => handleAuthApp(0)}
                          checked={isRemoteRemedyAuth}
                        />
                        <label
                          htmlFor="RemoteRemedyAuth"
